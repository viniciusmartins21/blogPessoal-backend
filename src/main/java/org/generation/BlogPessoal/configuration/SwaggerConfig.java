...
public class SwaggerConfig {
	...
	public static ApiInfo metadata() {
		return new ApiInfoBuilder().title("API - Blog Pessoal").description("API Spring Boot de Blog Pessoal")
	...
	private static Contact contact() {
		return new Contact("Vinicius martins", "https://github.com/viniciusmartins21", "viniciusmartins.12@hotmail.com");
	}
